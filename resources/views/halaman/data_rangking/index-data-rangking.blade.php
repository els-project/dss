...
@section('title-breadcrumb', 'Rangking')

@section('subtitle-breadcrumb', 'Rangking')

@section('breadcrumb-1', 'Rangking')
...
@section('custom-scripts')
  ...
  <script type="text/javascript">
    ...
    $(function () {
        $('#modal-create-data-rangking').on('hidden.bs.modal', function () {
        $('#modal-create-data-rangking form')[0].reset();
    ...
    $(function () {
        $('#modal-update-data-rangking').on('hidden.bs.modal', function () {
